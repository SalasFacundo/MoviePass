                ...
                <div class="col-sm-4">
                    ...
                    <form action="<?= FRONT_ROOT ?>Cine/Add" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="nombre" placeholder="Nombre del cine..." required>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control" name="id" placeholder="ID cine...." required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="direccion"
                                    placeholder="Nombre de la calle - numero..." required >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="precio" min="100" max="1500" placeholder="$..." required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control" min="1" max="25" name="salas"
                                    placeholder="Numero de total de salas..." required>
                            </div>
                        </div>
